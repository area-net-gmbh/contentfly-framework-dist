...
/**
 * Feste Werteliste einer Eigenschaft.
 *
 * `options` ist eine kommagetrennte Liste, wahlweise als `wert` oder `wert=Beschriftung`.
 * `SelectType` veroeffentlicht sie im Schema **und** prueft den Schreibwert dagegen
 * (`000-000-0017`).
 *
