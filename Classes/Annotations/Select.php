...
/**
 * Fixed list of values of a property.
 *
 * `options` is a comma-separated list, each entry either as `value` or `value=label`.
 * `SelectType` publishes it in the schema **and** validates the written value against it
 * (`000-000-0017`).
 *
