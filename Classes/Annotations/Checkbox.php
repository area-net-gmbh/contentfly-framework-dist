...
/**
 * Multiple selection on a ManyToMany relation.
 *
 * Stays despite the UI removal: the annotation selects the `CheckboxType`, which resolves the
 * collection and checks the read permissions, and `group` names the OptionGroup that is
