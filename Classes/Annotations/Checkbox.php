 ...
 *
 * Bleibt trotz des UI-Rueckbaus: die Annotation waehlt den `CheckboxType` aus, der die
 * Collection aufloest und die Leseberechtigungen prueft, und `group` benennt die
